...
const protectedRoles = ["👮‍♂️ capitão", "💂 sub-capitão", "⚽ jogador"];
...
export function banCommands(room: Room): void {
  ...
  room.command({
    name: "clearbans", aliases: ["cbans", "limparbans", "clear", "cb"], desc: "Limpa todos os bans.", usage: "clearbans", roles: ["admin", "👮‍♂️ capitão", "💂 sub-capitão", "⚽ jogador"], deleteMessage: true,
